...
public class Keys {
    ...
    public static final UniqueKey<StatusRecord> PK_STATUS = Internal.createUniqueKey(Status.STATUS, DSL.name("PK_STATUS"), new TableField[] { Status.STATUS.ID }, true);
    ...
    public static final ForeignKey<AttendanceRecord, StatusRecord> FK_ATTENDANCE_STATUS_ID = Internal.createForeignKey(Attendance.ATTENDANCE, DSL.name("FK_ATTENDANCE_STATUS_ID"), new TableField[] { Attendance.ATTENDANCE.STATUSID }, Keys.PK_STATUS, new TableField[] { Status.STATUS.ID }, true);
